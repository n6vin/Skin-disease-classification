...
src_path=r'yolo_structure/2_Training/src'
print(src_path)
utils_path=r'yolo_structure/Utils'
print(utils_path)
...
client = Cloudant.iam('170a917d-ade9-4418-acbc-3496fde49aca-bluemix','ysz5LUVqj8feJn2Binb3H_GRHegLopSE_VJ9_6GPesqf', connect=True)
...
app=Flask(__name__)
port_no=5000
ngrok.set_auth_token("eyJraWQiOiIyMDIyMTExMjA4MjgiLCJhbGciOiJSUzI1NiJ9")
...
def res():
    ...
    return render_template('predict.html',prediction=d[res],path="../static/img/"+f.filename)
